						...
						<div class="row" id="login-container">
							<div class="col-xs-12 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">	
								<div class="no-padding">
									<form class="smart-form client-form" method="POST" action="{{ route('password.update') }}">
										@csrf
										<input type="hidden" name="token" value="{{ $token }}">
										<section class="form-group">
											<label class="input"> <i class="icon-append fa fa-user"></i>
												<input class="form-control  @error('email') is-invalid @enderror" type="email" name="email" id="email" autofocus value="{{ $email ?? old('email') }}" required autocomplete="email">
												@error('email')
										...
										<section class="form-group">
											<label class="input"> <i class="icon-append fa fa-lock"></i>
				                                ...
				                                @enderror
												<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> Introduce tu nueva contraseña</b>
											</label>
										</section>
										...
										<section class="form-group">
											<label class="input"> <i class="icon-append fa fa-lock"></i>
												...
												<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> Confirma Contraseña</b>
											</label>
										</section>
